...
<div class="container">
    <div class="mb-5">
        ...
        <a href="/foto/crear?album_id={{ $album->album_id }}" class="btn btn-primary rounded-pill shadow-sm" style="padding: 0.75rem 2rem; font-weight: 600;">
                ...
                <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden transition" style="transition: all 0.3s ease;">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="d-flex gap-2 mt-auto pt-3">
                            <a href="/foto/actualizar?foto_id={{ $foto->foto_id }}" class="btn btn-sm btn-outline-success rounded-pill fw-600 flex-grow-1">
                                <i class="bi bi-pencil me-1"></i>Editar
                            </a>
                            <a href="/foto/eliminar?foto_id={{ $foto->foto_id }}" class="btn btn-sm btn-outline-danger rounded-pill fw-600 flex-grow-1">
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="text-center py-5">
                    ...
                    <a href="/foto/crear?album_id={{ $album->album_id }}" class="btn btn-primary rounded-pill px-4" style="padding: 0.75rem 2rem; font-weight: 600;">
                        <i class="bi bi-plus-lg me-2"></i>Agregar Foto
                    </a>
                </div>
            </div>
