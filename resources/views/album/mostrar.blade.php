                ...
                <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden transition" style="transition: all 0.3s ease;">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="d-grid gap-2 mt-auto pt-3">
                            <a href="{{ route('album.fotos', ['album_id' => $album->album_id]) }}" class="btn btn-sm btn-outline-primary rounded-pill fw-600">
                                <i class="bi bi-images me-1"></i>Ver Fotos
                            </a>
                            <div class="d-flex gap-2">
                                <a href="{{ route('album.editar', ['album_id' => $album->album_id]) }}" class="btn btn-sm btn-outline-success rounded-pill fw-600 flex-grow-1">
                                    <i class="bi bi-pencil me-1"></i>Editar
                                </a>
                                <a href="{{ route('album.eliminar_vista', ['album_id' => $album->album_id]) }}" class="btn btn-sm btn-outline-danger rounded-pill fw-600 flex-grow-1">
